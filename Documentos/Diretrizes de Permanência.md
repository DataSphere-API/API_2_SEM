...
Falta de participação recorrente pode resultar em advertência e/ou desligamento da equipe.
...
As tarefas devem ser entregues dentro do prazo da sprint.
O prazo para entrega deve ser a quarta-feira da última semana (terceira semana) de sprint.
...
Problemas técnicos, atrasos ou impedimentos devem ser comunicados o mais cedo possível.
...
Todo código deve ser enviado via repositório oficial (ex.: Git).

Pull requests devem ser revisados pelo P.O.
...
Críticas devem ser feitas de forma educada e focadas no projeto.
...
Não participar de uma sprint.

Não entregar tarefas repetidamente.

Não comparecer às reuniões sem justificativa.
...
A equipe realiza uma retrospectiva.

Cada membro pode receber feedback de participação e contribuição.

Ajustes de comportamento e responsabilidades podem ser definidos para a próxima sprint.

Objetivo: garantir que todos contribuam de forma justa e que o projeto avance com qualidade dentro das 3 sprints.